...
CREATE TABLE mock_alarm (
    ...
    tenant_id    VARCHAR(32)  DEFAULT 'tenant-001' COMMENT '租户ID（数据隔离）',
    dept_id      VARCHAR(32)  DEFAULT 'dept-prod-ops' COMMENT '部门ID（数据隔离）',
...
INSERT INTO mock_alarm (tenant_id, dept_id, alert_id, resource_id, resource_type, severity, msg, status, trigger_time) VALUES
-- CPU 类（tenant-001 / dept-prod-ops）
('tenant-001', 'dept-prod-ops', 'A001', 'ecs-001', 'ecs', 'CRITICAL', 'CPU使用率持续10分钟超过90%，当前95.2%', 'unresolved', '2026-07-01 14:00:00'),
('tenant-001', 'dept-prod-ops', 'A002', 'ebm-001', 'ebm', 'CRITICAL', '裸金属内存使用率超过92%，疑似内存泄漏', 'unresolved', '2026-07-01 14:10:00'),
-- 磁盘/存储类
('tenant-001', 'dept-prod-ops', 'A003', 'phy-001', 'phy', 'CRITICAL', '物理机系统盘使用率达到97%，剩余空间不足5GB', 'unresolved', '2026-07-01 14:20:00'),
('tenant-001', 'dept-prod-ops', 'A004', 'nas-001', 'nas', 'WARNING',  'NAS文件存储容量使用率达到88%，建议扩容', 'unresolved', '2026-07-01 14:25:00'),
('tenant-001', 'dept-prod-ops', 'A005', 'disk-003','disk','WARNING',  '云硬盘IOPS持续5分钟超过2000，可能影响性能', 'resolved',   '2026-07-01 13:00:00'),
('tenant-001', 'dept-prod-ops', 'A006', 'sfs-001', 'sfs', 'WARNING',  '弹性文件服务吞吐量下降30%，可能存在瓶颈', 'unresolved', '2026-07-01 14:35:00'),
-- 实例状态类
('tenant-001', 'dept-prod-ops', 'A007', 'ecs-005', 'ecs', 'CRITICAL', '实例状态异常，健康检查连续失败3次，可能已宕机', 'unresolved', '2026-07-01 14:30:00'),
('tenant-001', 'dept-prod-ops', 'A008', 'ebm-002', 'ebm', 'WARNING',  '裸金属温度传感器告警，CPU温度82°C接近阈值', 'unresolved', '2026-07-01 14:40:00'),
-- 网络类
('tenant-001', 'dept-prod-ops', 'A009', 'ecs-002', 'ecs', 'WARNING',  '网络入带宽峰值超过800Mbps', 'resolved',   '2026-07-01 13:00:00'),
('tenant-001', 'dept-prod-ops', 'A010', 'eip-001', 'eip', 'INFO',     '弹性IP带宽利用率达到75%', 'resolved',       '2026-07-01 12:30:00'),
-- GPU类（tenant-003 / dept-ai）
('tenant-003', 'dept-ai',      'A011', 'gpu-001', 'gpu', 'CRITICAL', 'GPU显存使用率超过95%，可能导致OOM', 'unresolved', '2026-07-01 14:45:00'),
('tenant-003', 'dept-ai',      'A012', 'gpu-002', 'gpu', 'WARNING',  'GPU利用率持续30分钟低于10%，资源闲置', 'unresolved', '2026-07-01 14:50:00'),
-- 综合类
('tenant-001', 'dept-prod-ops', 'A013', 'ecs-007', 'ecs', 'WARNING',  '云主机网络丢包率达到2%', 'unresolved', '2026-07-01 14:55:00'),
('tenant-001', 'dept-prod-ops', 'A014', 'phy-002', 'phy', 'WARNING',  '物理机CPU负载不均衡，核间差异超过40%', 'unresolved', '2026-07-01 15:00:00'),
('tenant-001', 'dept-prod-ops', 'A015', 'ecs-009', 'ecs', 'CRITICAL', '云主机磁盘IO等待时间超过500ms', 'unresolved', '2026-07-01 15:05:00');
...
-- ============ 补充 tenant-001 6月完整记录（按量计费全量） ============
INSERT INTO mock_billing_stream (stream_id, billing_resource_id, tenant_id, tenant_name, resource_name, resource_type, type, billing_period, total_amount, payable_amount, start_time, end_time) VALUES
('S044', 'disk-003', 'tenant-001', '生产-web组',  '系统盘100GB',    'disk', 1, 202606, 30.00,  30.00,  '2026-06-01 00:00:00', '2026-06-30 23:59:59'),
('S045', 'eip-002', 'tenant-001', '生产-web组',  'EIP-10.0.1.102', 'eip',  1, 202606, 45.00,  45.00,  '2026-06-01 00:00:00', '2026-06-30 23:59:59'),
('S046', 'ecs-005', 'tenant-001', '生产-web组',  '生产-web-03',    'ecs',  1, 202606, 142.00, 142.00, '2026-06-01 00:00:00', '2026-06-30 23:59:59'),
('S047', 'ecs-007', 'tenant-001', '生产-web组',  '生产-web-04',    'ecs',  1, 202606, 168.20, 168.20, '2026-06-01 00:00:00', '2026-06-30 23:59:59'),
('S048', 'ecs-009', 'tenant-001', '生产-db组',   '生产-db-02',     'ecs',  2, 202606, 1099.00, 899.00, '2026-06-01 00:00:00', '2026-06-30 23:59:59');

-- ============ tenant-001 7月完整月账单（按量 + 包年包月） ============
INSERT INTO mock_billing_stream (stream_id, billing_resource_id, tenant_id, tenant_name, resource_name, resource_type, type, billing_period, total_amount, payable_amount, start_time, end_time) VALUES
('S049', 'ecs-001', 'tenant-001', '生产-web组',  '生产-web-01',    'ecs',  1, 202607, 195.30, 195.30, '2026-07-01 00:00:00', '2026-07-31 23:59:59'),
('S050', 'ecs-002', 'tenant-001', '生产-web组',  '生产-web-02',    'ecs',  1, 202607, 160.80, 160.80, '2026-07-01 00:00:00', '2026-07-31 23:59:59'),
('S051', 'ecs-003', 'tenant-001', '生产-db组',   '生产-db-01',     'ecs',  2, 202607, 899.00, 799.00, '2026-07-01 00:00:00', '2026-07-31 23:59:59'),
('S052', 'ecs-005', 'tenant-001', '生产-web组',  '生产-web-03',    'ecs',  1, 202607, 148.60, 148.60, '2026-07-01 00:00:00', '2026-07-31 23:59:59'),
('S053', 'ecs-007', 'tenant-001', '生产-web组',  '生产-web-04',    'ecs',  1, 202607, 172.40, 172.40, '2026-07-01 00:00:00', '2026-07-31 23:59:59'),
('S054', 'ecs-009', 'tenant-001', '生产-db组',   '生产-db-02',     'ecs',  2, 202607, 1099.00, 899.00, '2026-07-01 00:00:00', '2026-07-31 23:59:59'),
('S055', 'disk-001', 'tenant-001', '生产-web组',  '系统盘100GB',    'disk', 1, 202607, 30.00,  30.00,  '2026-07-01 00:00:00', '2026-07-31 23:59:59'),
('S056', 'disk-002', 'tenant-001', '生产-web组',  '数据盘500GB',    'disk', 1, 202607, 150.00, 150.00, '2026-07-01 00:00:00', '2026-07-31 23:59:59'),
('S057', 'disk-003', 'tenant-001', '生产-web组',  '系统盘100GB',    'disk', 1, 202607, 30.00,  30.00,  '2026-07-01 00:00:00', '2026-07-31 23:59:59'),
('S058', 'eip-001', 'tenant-001', '生产-web组',  'EIP-10.0.1.101', 'eip',  1, 202607, 45.00,  45.00,  '2026-07-01 00:00:00', '2026-07-31 23:59:59'),
('S059', 'eip-002', 'tenant-001', '生产-web组',  'EIP-10.0.1.102', 'eip',  1, 202607, 45.00,  45.00,  '2026-07-01 00:00:00', '2026-07-31 23:59:59'),
('S060', 'nas-001', 'tenant-001', '生产-web组',  'NAS文件存储1TB',  'nas',  2, 202607, 299.00, 299.00, '2026-07-01 00:00:00', '2026-07-31 23:59:59'),
('S061', 'disk-004', 'tenant-001', '生产-db组',   '系统盘50GB',     'disk', 1, 202607, 15.00,  15.00,  '2026-07-01 00:00:00', '2026-07-31 23:59:59'),
('S062', 'disk-005', 'tenant-001', '生产-db组',   '数据盘200GB',    'disk', 1, 202607, 60.00,  60.00,  '2026-07-01 00:00:00', '2026-07-31 23:59:59'),
('S063', 'eip-003', 'tenant-001', '生产-db组',   'EIP-10.0.1.103', 'eip',  1, 202607, 45.00,  45.00,  '2026-07-01 00:00:00', '2026-07-31 23:59:59');

-- ============ tenant-001 8月预估账单（包年包月 + 按量估算） ============
INSERT INTO mock_billing_stream (stream_id, billing_resource_id, tenant_id, tenant_name, resource_name, resource_type, type, billing_period, total_amount, payable_amount, start_time, end_time) VALUES
('S064', 'ecs-001', 'tenant-001', '生产-web组',  '生产-web-01',    'ecs',  1, 202608, 62.49,  62.49,  '2026-08-01 00:00:00', '2026-08-05 23:59:59'),
('S065', 'ecs-002', 'tenant-001', '生产-web组',  '生产-web-02',    'ecs',  1, 202608, 51.27,  51.27,  '2026-08-01 00:00:00', '2026-08-05 23:59:59'),
('S066', 'ecs-005', 'tenant-001', '生产-web组',  '生产-web-03',    'ecs',  1, 202608, 47.00,  47.00,  '2026-08-01 00:00:00', '2026-08-05 23:59:59'),
('S067', 'disk-001', 'tenant-001', '生产-web组',  '系统盘100GB',    'disk', 1, 202608, 5.50,   5.50,   '2026-08-01 00:00:00', '2026-08-05 23:59:59'),
('S068', 'disk-002', 'tenant-001', '生产-web组',  '数据盘500GB',    'disk', 1, 202608, 27.42,  27.42,  '2026-08-01 00:00:00', '2026-08-05 23:59:59');
